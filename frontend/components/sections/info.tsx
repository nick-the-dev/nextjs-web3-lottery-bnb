    ...
    <section className="info" id="info">
      ...
      <div className="cards-wrapper">
        ...
        <Card>
          ...
          <p className="card-desc">
            {
              "NFT Loottery is a unique opportunity to significantly increase your profits! Each Loottery NFT is a ticket to participate in our lotteries to win 1 BNB, GOLD TICKET and some juicy prizes..."
            }
          </p>
        </Card>
      </div>
